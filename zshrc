...
alias alacritty.yml="nano ~/.config/alacritty/alacritty.yml"
alias kittyconfig="nano ~/.config/kitty/kitty.conf"
alias nanorc="nano ~/.nanorc"
alias vimrc="nvim /etc/xdg/nvim/init.vim"
alias userChrome="nano ~/.mozilla/firefox/al4zpld7.default-release/chrome/userChrome.css"
...
alias darq="bash ~/Scripts/DarQ/rundarq-linux-mac.sh"
alias email="neomutt"
alias chat="weechat"
alias reddit="tuir -s"
alias edit="nano"
